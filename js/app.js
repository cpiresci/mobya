...
const Notif = (() => {
  ...
  // Alias usado por NotificacoesPage (js/notificacoes-page.js) após marcar
  // notificações como lidas, para atualizar o badge do header.
  function refresh() { return _fetchCount(); }

  return { toggle, markRead, markAll, start, stop, refresh };
})();
window.Notif = Notif;
